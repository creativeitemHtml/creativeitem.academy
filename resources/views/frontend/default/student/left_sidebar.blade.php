...
<div class="user-sidebar">
    <div class="user-sidebar-profile mx-auto mb-3">
        <img src="{{ get_image(auth()->user()->photo) }}" alt="user">
    </div>
    <h3 class="hs-title-18px fw-semibold text-center mb-1">{{ auth()->user()->name }}</h3>
    <p class="man-subtitle-14px text-center mb-4 text-break">{{ auth()->user()->email }}</p>
    <nav>
        <ul class="d-flex flex-column gap-2px">


            <li class="@if ($current_route == 'my.courses') active @endif">
                <a href="{{ route('my.courses') }}" class="sb-nav-link @if ($current_route == 'my.courses') active @endif ">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M18.3334 13.95V3.89162C18.3334 2.89162 17.5167 2.14995 16.5251 2.23329H16.4751C14.7251 2.38329 12.0667 3.27495 10.5834 4.20829L10.4417 4.29995C10.2001 4.44995 9.80008 4.44995 9.55841 4.29995L9.35008 4.17495C7.86675 3.24995 5.21675 2.36662 3.46675 2.22495C2.47508 2.14162 1.66675 2.89162 1.66675 3.88329V13.95C1.66675 14.75 2.31675 15.5 3.11675 15.6L3.35841 15.6333C5.16675 15.875 7.95841 16.7916 9.55841 17.6666L9.59175 17.6833C9.81675 17.8083 10.1751 17.8083 10.3917 17.6833C11.9917 16.8 14.7917 15.875 16.6084 15.6333L16.8834 15.6C17.6834 15.5 18.3334 14.75 18.3334 13.95Z"
                            stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M10 4.57495V17.075" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M6.45825 7.07495H4.58325" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M7.08325 9.57495H4.58325" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <li class="@if ($current_route == 'my.profile') active @endif">
                <a href="{{ route('my.profile') }}" class="sb-nav-link @if ($current_route == 'my.profile') active @endif">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.0999 10.65C10.0416 10.6417 9.9666 10.6417 9.89993 10.65C8.43327 10.6 7.2666 9.39998 7.2666 7.92498C7.2666 6.41665 8.48327 5.19165 9.99993 5.19165C11.5083 5.19165 12.7333 6.41665 12.7333 7.92498C12.7249 9.39998 11.5666 10.6 10.0999 10.65Z" stroke="#1A1C1F"
                            stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M15.6166 16.15C14.1333 17.5084 12.1666 18.3334 9.99997 18.3334C7.8333 18.3334 5.86663 17.5084 4.3833 16.15C4.46663 15.3667 4.96663 14.6 5.8583 14C8.14163 12.4834 11.875 12.4834 14.1416 14C15.0333 14.6 15.5333 15.3667 15.6166 16.15Z" stroke="#1A1C1F"
                            stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M10.0001 18.3333C14.6025 18.3333 18.3334 14.6023 18.3334 9.99996C18.3334 5.39759 14.6025 1.66663 10.0001 1.66663C5.39771 1.66663 1.66675 5.39759 1.66675 9.99996C1.66675 14.6023 5.39771 18.3333 10.0001 18.3333Z" stroke="#1A1C1F" stroke-width="1.25"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span>{{ get_phrase('প্রোফাইল') }}</span>
                </a>
            </li>
            ...
            <li class="@if ($current_route == 'purchase.history' || $current_route == 'invoice') active @endif">
                <a href="{{ route('purchase.history') }}" class="sb-nav-link @if ($current_route == 'purchase.history' || $current_route == 'invoice') active @endif">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M10 6.25V13.75" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M18.3334 9.99996C18.3334 14.6 14.6001 18.3333 10.0001 18.3333C5.40008 18.3333 1.66675 14.6 1.66675 9.99996C1.66675 5.39996 5.40008 1.66663 10.0001 1.66663" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M18.3333 4.99996V1.66663H15" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M14.1667 5.83329L18.3334 1.66663" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <li>
                <a href="#" class="sb-nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M5.7417 14.575L7.65837 16.4916" stroke="#1A1C1F" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M12.0833 9.16663C12.7736 9.16663 13.3333 8.60698 13.3333 7.91663C13.3333 7.22627 12.7736 6.66663 12.0833 6.66663C11.3929 6.66663 10.8333 7.22627 10.8333 7.91663C10.8333 8.60698 11.3929 9.16663 12.0833 9.16663Z" stroke="#1A1C1F" stroke-width="1.25"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
            ...
            <li>
                <a href="{{ route('logout') }}" class="sb-nav-link">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.41675 6.29995C7.67508 3.29995 9.21675 2.07495 12.5917 2.07495H12.7001C16.4251 2.07495 17.9167 3.56662 17.9167 7.29162V12.725C17.9167 16.45 16.4251 17.9416 12.7001 17.9416H12.5917C9.24175 17.9416 7.70008 16.7333 7.42508 13.7833" stroke="#1A1C1F"
                            stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M12.4999 10H3.0166" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M4.87492 7.20837L2.08325 10L4.87492 12.7917" stroke="#1A1C1F" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
        ...
        @if (auth()->user()->role == 'student')
            <a href="{{ route('become.instructor') }}" class="btn bn-btn-skin w-100 mb-12px mt-3">
                {{ get_phrase('একজন প্রশিক্ষক হন') }}
            </a>
        @endif
    </nav>
</div>
