                ...
                <div class="col-lg-12">
                    <div class="my-panel">
                        <div class="over-image">
                            <img src="{{ asset('assets/frontend/default/image/courses-bg.png') }}" class="banner" alt="student-panel-banner">

                            <button class="upload-image-btn" onclick="ajaxModal('{{ route('modal', ['frontend.default.upload_profile_pic', 'id' => auth()->user()->id]) }}', '{{ get_phrase('Upload picture') }}')">
                            ...
                            <div class="col-lg-4 col-md-5">
                                @if (auth()->user()->role == 'student')
                                    <div class="my-course-btn">
                                        <a href="{{ route('become.instructor') }}" class="eBtn gradient">{{ get_phrase('Become an instructor') }}</a>
                                    </div>
                                @endif
                            </div>
                        </div>
