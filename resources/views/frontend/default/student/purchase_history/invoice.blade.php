                ...
                <div class="col-lg-9">
                    <div class="content-card">
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-3 mt-3">
                            <a class="btn bn-btn-skin subtle" href="{{ route('purchase.history') }}">{{ get_phrase('Back') }}</a>
                            <a class="btn bn-btn-skin" id="print" href="javascript:void(0);" onclick="printableDiv('invoice')">{{ get_phrase('Print') }}</a>
                        </div>
                    </div>
                </div>
            </div>
