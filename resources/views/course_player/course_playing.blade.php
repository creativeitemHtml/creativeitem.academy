                                ...
                                <li>
                                    ...
                                    <ul class="ul-ol course-content-items">
                                        @foreach ($lesson as $lessons)
                                            <a href="{{ route('course.player', ['slug' => $course_details->slug, 'id' => $lessons->id]) }}" class="item @if (Route::currentRouteName() == 'course.player') active @endif">
                                                <div class="left">
                                    ...
                                    @for ($i = 0; $i < 5; $i++)
                                        @if ($i < $average_rating)
                                            <li class="d-flex align-items-center">
                                                <img src="{{ asset('assets/frontend/images/icon/star-rating.svg') }}" alt="" />
                                            </li>
                                        @else
                                            <li class="d-flex align-items-center">
                                                <img src="{{ asset('assets/frontend/images/icon/star-rating-2.svg') }}" alt="" />
                                            </li>
                                        @endif
                                    @endfor
                                @else
