...
<div class="tab-pane fade" id="pills-certificate" role="tabpanel" aria-labelledby="pills-certificate-tab" tabindex="0">
    <div>
        <h4 class="hs-title-20px mb-12px">কমপ্লিশন সার্টিফিকেট</h4>
        <p class="hs-subtitle-16px mb-32px">আপনি সাকসেসফুললি আপনার কোর্সটি কমপ্লিট করেছেন। আপনার সার্টিফিকেট ডাউনলোড এবং শেয়ার করুন।</p>
        <div class="d-flex align-items-center gap-3 flex-wrap">
            <a href="#" class="btn bn-btn-skin py-2">
                <img src="assets/images/icon/download-black-20.svg" alt="icon">
                <span>ডাউনলোড</span>
            </a>
            <a href="#" class="btn bn-btn-outline-secondary py-2">
                <img src="assets/images/icon/share-black-20.svg" alt="icon">
                <span>শেয়ার</span>
            </a>
        </div>
    </div>
